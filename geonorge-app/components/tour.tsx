...
export function TourProvider({
  ...
  const [isCompleted, setIsCompletedInternal] = useState(false);

  // --- Check if tour has been completed ---
  useEffect(() => {
    try {
      const completed = localStorage.getItem("geonorgeTourCompleted");
      if (completed === "true") {
      ...
      <AlertDialogContent className="max-w-md w-full p-0 rounded-2xl shadow-2xl overflow-hidden">
        <AlertDialogTitle asChild>
          <span className="not-sr-only">
            <GeoNorgeLogo className="h-auto w-72 pt-4 mx-auto" />
          </span>
        </AlertDialogTitle>

        <div className="flex flex-col items-center">
          <div className="w-full px-6 text-black text-center border-b border-gray-200">
            <p className=" text-black/90 pb-2">
          ...
          <div className="p-6 w-full">
            <div className="bg-orange-50 rounded-xl p-4 mb-6 border border-orange-100">
              <h3 className="font-medium text-gray-800 mb-2">
                Hva kan du gjøre hos Geonorge & GeoGPT?
              </h3>
            ...
            <div className="flex flex-col space-y-3">
              <Button
                ...
                className="bg-color-gn-primary hover:bg-color-gn-primary/80 text-white py-2 rounded-lg w-full"
              >
                Start omvisning
              </Button>
              <Button
